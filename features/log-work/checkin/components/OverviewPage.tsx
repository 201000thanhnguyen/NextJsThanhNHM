    ...
    <div className="min-h-screen bg-gradient-to-b from-neutral-50 to-white">
      <div className="mx-auto w-full max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
        <div className="flex flex-col gap-6">
          ...
          <div className="grid gap-4 lg:grid-cols-[1fr_1.2fr]">
            <Card className="p-5 shadow-sm transition-all duration-200 hover:shadow-md">
              <div className="mb-4 flex items-center justify-between">
                <div className="text-sm font-semibold text-neutral-900">Ghi nhận thanh toán</div>
              </div>
            ...
            <Card className="p-5 shadow-sm transition-all duration-200 hover:shadow-md">
              <div className="mb-4 flex items-center justify-between">
                <div className="text-sm font-semibold text-neutral-900">Lịch sử thanh toán</div>
              </div>
          ...
          <Card className="p-5 shadow-sm transition-all duration-200 hover:shadow-md">
            <div className="mb-4 flex items-center justify-between">
              <div className="text-sm font-semibold text-neutral-900">Bảng kê theo tháng</div>
            </div>
              ...
              <div className="space-y-2">
                {summary?.monthlyBreakdown.map(item => (
                  ...
                  >
                    ...
                    <div className="text-sm text-neutral-600">Tổng tháng: {currency(item.earned)}</div>
                    <div className="text-sm text-neutral-600">Đã trả: {currency(item.paidTotal)}</div>
